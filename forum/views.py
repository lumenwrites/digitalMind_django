...
def main(request):
    ...
    return render_to_response("forum/list.html", dict(forums=forums, user=request.user),context_instance=RequestContext(request))
...
def forum(request, pk):
    ...
    return render_to_response("forum/forum.html", add_csrf(request, threads=threads, pk=pk, forum=forum),context_instance=RequestContext(request))
...
def thread(request, pk):
    ...
    forum = Forum.objects.get(pk=t.forum.pk)
    return render_to_response("forum/thread.html", add_csrf(request, posts=posts, pk=pk, title=t.title, forum_pk=t.forum.pk, forum=forum, media_url=MEDIA_URL),context_instance=RequestContext(request))
